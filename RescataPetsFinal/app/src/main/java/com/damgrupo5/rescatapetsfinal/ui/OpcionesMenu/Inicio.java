...
public class Inicio extends Fragment {
    ...
    private String[] stringPrueba;
    private String[] stringNomMascota;
    ...
    private void dataInitialize() {
        ...
        for(int i = 0; i < stringPrueba.length; i++){
            Anuncios anuncios = new Anuncios(stringPrueba[i], stringNomMascota[i]);
            /*
            Anuncios anunciosDB = new Anuncios("idAnuncio", "idUser",  "idTipoAnun",  stringPrueba[i], nomMascotaAnuncio[i],
                     "idTipoMascota",  "descTipoMasc",  "razaMascota",  "colorMascota",
                     "idCountry",  "nomCountry",  "lastLocation",  "reward",  "fotoMascota");*/
            anunciosArrayList.add(anuncios);
        }
